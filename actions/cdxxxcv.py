# Liste initiale de stations et codes
...
# Inversion de la liste de stations et codes avec des listes de valeurs
inverted_mapping = {}
for key, value in station_mapping.items():
    if value not in inverted_mapping:
        ...
        if " " in key: # Vérifie si le nom contient un espace
            inverted_mapping[value].append(key.replace(" ", "").lower()) # Ajoute le nom sans espaces et en minuscules
    else:
...
print("Dictionnaire inversé :", inverted_mapping)
